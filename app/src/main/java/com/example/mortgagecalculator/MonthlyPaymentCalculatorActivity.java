...
public class MonthlyPaymentCalculatorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPeriodCalActivity.setOnClickListener(view -> {
        ...
        btnCalculateMonthlyPayment.setOnClickListener(view -> {
            initEditText();
            ...
            if (!getPrincipal().getText().toString().isEmpty() &&
                ...
                if(principal > 0 && principal <= 1000000000 &&
                    ...
                    String numPayments = String.valueOf(paymentCalculator.getNumberOfPayments());
